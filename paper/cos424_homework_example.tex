...
\setenumerate{itemsep=0em,topsep=0em,after=0em}
...
The background dataset is primarily composed of answers to survey questions from the FFCWS. Each row uniquely identifies a child and each column is either an ID of some form or an answer to a survey question. In this dataset, there are 4242 rows and 12945 columns.
